...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: "/common/js/ueditor/"
        ...
        toolbars: [
                [
                    ...
                    'simpleupload', 'insertimage', 'emotion', 'insertframe', 'pagebreak', '|',
                    'horizontal', 'date', 'time', 'spechars', 'wordimage', '|',
                    'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'equation'
                ]
            ]
        ...
        //,theme:'default'
        ,
        themePath: "/common/js/ueditor/themes/"
