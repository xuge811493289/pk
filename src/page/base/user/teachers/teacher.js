...
export default {
    ...
    methods: {
                            ...
                            if (this.$isArry(data.data)) {
                                ...
                                if (data.data.toLowerCase() === 'success') {
                                    ...
                                    if (store.state.userId) {
                                        if (store.state.userId === this.editForm.id) {
                                            store.state.realName = this.editForm.realName;
        ...
        // 跳转导入页面
        toImportMsg() {
            this.$router.push({ name: 'teachersImport', params: { unitId: this.currentUnitId, currentNodeKey: this.currentNodeKey, unitType: this.unitType } });
        },
        // 分页事件
