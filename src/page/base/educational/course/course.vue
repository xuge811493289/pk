<template>
    <div class="app-container-box">
        <sy-grad-4>
            <!-- <div slot="headerRight" style="text-align: right;line-height: 40px;">
                <el-button @click="toAdd(undefined)">新增</el-button>
            </div> -->

            <div slot="bodyRight">
                <div v-if="isTreeDatasEmpty" style="position: absolute;left: 0px;right: 0px;top: 0px;bottom: 0px;text-align: center;line-height: 300px;font-size: 14px;">暂无数据</div>
                <ul v-else id="coursesTree" class="ztree full-parent-height sy-course-tree" style="overflow: hidden;overflow-y: auto;margin: 10px auto;height: calc(100% - 20px);"></ul>
            </div>
        </sy-grad-4>
        <!--修改课程父节点-->
                        ...
                        <el-col :span="24">
                            <el-table border style="width: 100%;" :data="addModel.typeDatas" max-height="300" v-if="addModel.addType == '1'">
                                <el-table-column label="序号" header-align="center" align="center">
                                    <template scope="scope">
                                        ...
                                        <el-input-number :debounce="0" v-model="scope.row.sort" :min="0" :max="1000" :controls="false" size="small" style="width: 270px;display: inline-block;"></el-input-number>
                                    </template>
                                </el-table-column>
                            ...
                            <el-table border style="width: 100%" :data="addModel.courseDatas" max-height="300" v-if="addModel.addType == '2'">
                                <el-table-column label="序号" prop="sort" header-align="center" align="center">
                                    <template scope="scope">
                                        <span class="xing ib"></span>
                                        <el-input-number :debounce="0" v-model="scope.row.sort" :min="0" :max="1000" :controls="false" size="small" style="width: 90px;display: inline-block;"></el-input-number>
                                    </template>
                                </el-table-column>
