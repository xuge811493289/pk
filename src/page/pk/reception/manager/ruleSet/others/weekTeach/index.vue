	...
	<div class="others_rightContent">
	  ...
	  <div class="tblData">	    
	    <el-table :data="tableData" border style="width: 100%"> 
	      ...
	      <el-table-column label="周内分布" align="center">
	        <template scope="scope">
	        	<el-radio-group v-model="scope.row.distribution"  @change.native="changeImportance(scope.row)">
	        		<el-radio :label="3">周内分散</el-radio>
		        	<el-radio :label="4">周内集中</el-radio>
		        </el-radio-group>
	        </template>
	      </el-table-column>
        ...
        if(solution){
          this.solutionId = solution;
			...
			selectCourse(courseId){
				...
				if(path[path.length-1] == 'weekTeach'){
					this.saveParams.type = '4';
				}
				let param = {
